Feature: integration test
  ...
  Scenario Outline: create credit positive
    ...
    Examples:
      ...
      | {"person":{"firstName":"Alexandra","lastName":"Chernyshova"},"amount":20,"agreementAt":2018,"currency":"USD","duration":17,"percent":20}              |
      ...
      | {"person":{"firstName":"Alexandra","lastName":"Chernyshova"},"amount":50000,"agreementAt":756,"currency":"USD","duration":25,"percent":18}           |
